 ...
 * @LastEditors: 張国慶
 * @LastEditTime: 2022-03-28 15:58:11
 * @FilePath: /backend/app/Http/Kernel.php
 * @Description: 
 * 
...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\Http\Middleware\Api\AssignRequestId::class,
    ...
    protected $routeMiddleware = [
        ...
        'stuff'=>\App\Http\Middleware\Api\StuffMiddleware::class,
